...
output_file_path = "../../data2/tom/RNA/heavy_modifications_chr.tsv"
output_graph_path = "../../data2/tom/RNA/heavy_modifications_chr.png"
...
input_file_path = "../../data2/tom/RNA/25%_highest_relative_rates_genes.tsv"
...
for num, (name, group) in enumerate(df_grouped):
    group.plot(kind='scatter', x='ind', y='relative_average_modification_rate', color=colors[num % len(colors)], ax=ax) # y = 'GMM_logit_pvalue', color=colors[num % len(colors)], ax=ax) 
    #y='mod_rate_change'
...
ax.set_ylabel('Mean mRNA modification rate')
ax.set_title("Mean mRNA modification rate against genomic position")
